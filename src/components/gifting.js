...
export default function GiftingSection() {
  return (
    <section className="relative w-full py-20 px-20 before:absolute before:inset-0 before:bg-gradient-to-l before:from-[var(--primary)]/30 before:to-transparent before:z-0">
